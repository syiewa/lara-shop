    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <form role="form" action='{{route('backend.slideshow.update',$slide->id)}}' method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <img class="img-responsive center-block" src="{{asset('images/slideshow/thumb/'.$slide->ss_image)}}" />
                         </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Slideshow Title</label>
                            <input type="text" value="{{$slide->ss_name}}" class="form-control" id="name" placeholder="Enter Title" name='ss_name'>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Slideshow URL</label>
                            <input type="text" value="{{$slide->ss_url}}" class="form-control" id="name" placeholder="Enter URL" name='ss_url'>
                        </div>
                        <div class="form-group" id="fcontent">
                            <label for="exampleInputEmail1">Slideshow Description</label>
                            <textarea id="summernote" name="ss_description">{{$slide->ss_description}}</textarea>
                        </div>
                        <div class="form-group">
