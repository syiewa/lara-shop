...
$(document).ready(function() {
    ...
    $.get('{{ route("api.slideshow") }}', {}, function(data) {
        $('#nestable').html(data);
    });
    $('#save').click(function(e) {
        $('#nestable').slideUp(function() {
            var data = {"data": $('#nestable').nestable('serialize'), '_token': '{{csrf_token()}}'};
            $.post('{{route("api.postslideshow")}}', data, function(e) {
                $('#nestable').html(e);
            }).done(function() {
                $('#nestable').slideDown();
            });
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    <a class="btn btn-success" href="{{route('backend.slideshow.create')}}">Tambah Slideshow</a>
